...
private static final long serialVersionUID = 0L;
  ...
  private SummaryDataPoint(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  private static final long serialVersionUID = 0L;
    ...
    private ValueAtQuantile(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(io.opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile other) {
        ...
        if (java.lang.Double.doubleToRawLongBits(other.getQuantile()) != 0) {
  ...
  public static final class Builder extends
        ...
        if (!other.quantileValues_.isEmpty()) {
          if (quantileValuesBuilder_.isEmpty()) {
            ...
            quantileValuesBuilder_ = 
              com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                 internalGetQuantileValuesFieldBuilder() : null;
          } else {
    ...
    public io.opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile.Builder getQuantileValuesBuilder(
        int index) {
      return internalGetQuantileValuesFieldBuilder().getBuilder(index);
    }
    /**
     * <pre>
     * (Optional) list of values at different quantiles of the distribution calculated
    ...
    public io.opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile.Builder addQuantileValuesBuilder() {
      return internalGetQuantileValuesFieldBuilder().addBuilder(
    ...
    public java.util.List<io.opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile.Builder> 
      ...
      return internalGetQuantileValuesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilder<
        ...
        internalGetQuantileValuesFieldBuilder() {
      if (quantileValuesBuilder_ == null) {
        quantileValuesBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
            io.opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile, io.opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile.Builder, io.opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantileOrBuilder>(
                quantileValues_,
